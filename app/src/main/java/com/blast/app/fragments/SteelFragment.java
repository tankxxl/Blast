 ...
 * {@link SteelFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link SteelFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SteelFragment extends CommonFragment implements View.OnClickListener {
    ...
    private TextView et_thickness, et_area;
     ...
     * @return A new instance of fragment SteelFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SteelFragment newInstance(String param1, String param2) {
    ...
    public static SteelFragment getInstance() {
        return newInstance("", "");
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        et_thickness = (TextView) view.findViewById(R.id.et_thickness);
        ...
        et_area = (TextView) view.findViewById(R.id.et_area);
        ...
        switch (v.getId()) {
            case R.id.btn_calc:
                ...
                try {
                    ...
                    double result = blastCalc.steelBlast(d_area, d_thickness);
